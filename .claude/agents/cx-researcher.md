...
tools: Read,Grep,Glob,LS,WebSearch,WebFetch,list_skills,get_skill,search_skills,get_template,list_templates,memory_search,memory_add_observations,workflow_status,workflow_update_task,workflow_needs_main_input,cx_trace,cx_score
---
